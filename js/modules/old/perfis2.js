...
GR.Modules.Perfis = {
    ...
    // VERIFICAR SE O PERFIL PODE ACESSAR UMA PROPRIEDADE
    podeAcessarPropriedade: function(perfilId, propriedade) {
        var perfil = this.perfis[perfilId];
        if (!perfil) return true;
        
        // Se não tiver restrições, pode acessar todas
    ...
    // OBTER PROPRIEDADES PERMITIDAS PARA UM PERFIL
    ...
    // FILTRAR PROPRIEDADES DO USUÁRIO ATUAL
    filtrarPropriedadesUsuario: function() {
        ...
        // Se não tem restrição, mostra todas
        if (!propriedadesPermitidas || propriedadesPermitidas.length === 0) {
            return;
        }
        
        // Filtra as propriedades visíveis nas abas
        ...
        // Se a propriedade ativa não está permitida, muda para "Todas"
    ...
    // ALTERNAR PERMISSÃO DE PROPRIEDADE
    _togglePropriedadePermitida: function(perfilId, propriedade, checked) {
        ...
        // Se todas foram desmarcadas, considera como acesso total
        if (perfil.propriedadesPermitidas.length === 0) {
            perfil.propriedadesPermitidas = null;
        }
    },

    // MARCAR/DESMARCAR TODAS AS PROPRIEDADES
    ...
    _salvarPropriedadesPermitidas: function(perfilId) {
        ...
        // Se o array estiver vazio, define como null (acesso total)
        if (perfil.propriedadesPermitidas && perfil.propriedadesPermitidas.length === 0) {
            perfil.propriedadesPermitidas = null;
        }
    ...
    // ================================================================
    // RENDER MODAL DE GERENCIAMENTO DE PERFIS (COMPLETO)
    // ================================================================
        ...
        <div id="${modalId}" class="modal" role="dialog" aria-modal="true">
            <div class="modal-content" style="max-width:1200px;max-height:95vh;">
                ...
                <div style="padding:10px 0;">
                    ...
                    <!-- Seleção de Perfil + Botões de Ação -->
                    <div style="display:flex;gap:6px;flex-wrap:wrap;margin-bottom:12px;align-items:center;">
                        ...
                        <div style="display:flex;gap:4px;flex-wrap:wrap;margin-left:auto;">
                            ...
                            <!-- 🔥 BOTÃO NOVO: GERENCIAR PROPRIEDADES -->
                    ...
                    <div style="display:flex;gap:6px;flex-wrap:wrap;margin-bottom:10px;">
                        ...
                        <!-- 🔥 BOTÃO NOVO: GERENCIAR PROPRIEDADES (AÇÃO RÁPIDA) -->
    ...
    _selecionarPerfil: function(perfilId) {
        ...
        // 🔥 Atualiza exibição de propriedades
    ...
    _restaurarPadraoPerfil: function() {
        ...
        if (this.perfisPadrao[perfilId]) {
            ...
            // 🔥 Restaura também as propriedades permitidas
    ...
    _criarNovoPerfil: function() {
        ...
        this.perfis[id] = {
            ...
            cor: '#9c27b0',
            fixo: false,
            propriedadesPermitidas: null, // 🔥 Novo perfil tem acesso a todas
            permissoes: {
                ver: [],
                criar: [],
                editar: [],
    ...
    _clonarPerfil: function() {
        ...
        this.perfis[id].propriedadesPermitidas = perfil.propriedadesPermitidas || null; // 🔥 Clona também as propriedades
        this.perfisPersonalizados[id] = true;
