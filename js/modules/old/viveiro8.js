// ================================================================
// MÓDULO: VIVEIRO - SISTEMA COMPLETO COM PERMISSÕES (VERSÃO 2.8)
// ================================================================
// Versão: 2.8 - CORRIGIDO: Variedade com propriedade funcionando
// CORREÇÃO: salvamento de variedade com propriedade fixa
// ================================================================
...
GR.Modules.Viveiro = {
    ...
    salvarVariedade: function() {
        ...
        // ================================================================
        // CORREÇÃO CRÍTICA: OBTÉM A PROPRIEDADE DO SELECT OU DA PROPRIEDADE ATIVA
        // ================================================================
        var propriedade = propSelect ? propSelect.value : null;
        
        // SE O SELECT VEIO VAZIO OU NULO, USA A PROPRIEDADE ATIVA DO VIVEIRO
        if (!propriedade || propriedade === '' || propriedade === 'Selecione...') {
            propriedade = this.getPropriedadeAtiva();
        }
        
        // SE AINDA ESTIVER VAZIO, USA 'Padrão' COMO FALLBACK
        ...
        // MONTAGEM DO OBJETO DE DADOS COM PROPRIEDADE CORRETA
        var dados = {
...
console.log('✅ Módulo Viveiro v2.8 carregado com CORREÇÃO DA VARIEDADE!');
console.log('📌 CORREÇÕES APLICADAS:');
console.log('   - 🔧 CORRIGIDO: Salvamento de variedade com propriedade fixa');
console.log('   - 🔧 CORRIGIDO: Propriedade agora é capturada corretamente do select');
console.log('   - 🔧 CORRIGIDO: Fallback para propriedade ativa se select estiver vazio');
console.log('   - 🔧 CORRIGIDO: Fallback "Padrão" como último recurso');
console.log('   - 🔧 Botões de editar (✏️) agora aparecem para usuários com permissão');
console.log('   - 🔧 Botões de excluir (🗑️) agora aparecem para usuários com permissão');
...
console.log('   - ✏️ Editar (em todas as listas)');
console.log('   - 🗑️ Excluir (em todas as listas)');
console.log('   - ✅ Marcar como Pronta (na lista de mudas)');
console.log('   - 🗑️ Descartar (na lista de mudas)');