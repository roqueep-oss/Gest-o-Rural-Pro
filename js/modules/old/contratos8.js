...
GR.Modules.Contratos = {
    ...
    _extrairTodosOsDados: function(texto) {
        ...
        // ================================================================
            ...
            // 1º TENTATIVA: Buscar taxa entre aspas "6,0000"
            ...
            // 2º TENTATIVA: Buscar taxa no formato "X,XXXX" (4 casas decimais) que aparece depois de "PRONAF" ou "BNDES"
            ...
            // 4º TENTATIVA: Buscar qualquer número com formato "X,XXXX" no texto (4 casas decimais)
            if (dados.taxaJuros === 0) {
