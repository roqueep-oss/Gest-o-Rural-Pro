...
GR.Modules.Contratos = {
    ...
    // ================================================================
    // RENDER - LISTA DE CONTRATOS COM CARDS MELHORADOS
    // ================================================================
    render: function() {
        ...
        var statsHtml = '<div class="credito-stats-grid">' +
            ...
            '<div class="credito-stats-card warning"><div class="number">' + venc15 + '</div><div class="label">⚠️ Vence em 15 dias</div><div style="font-size:9px;color:var(--text-light);margin-top:2px;">' + venc15 + ' parcela' + (venc15 > 1 ? 's' : '') + '</div></div>' +
            '<div class="credito-stats-card info"><div class="number">' + venc30 + '</div><div class="label">📅 Vence em 30 dias</div><div style="font-size:9px;color:var(--text-light);margin-top:2px;">' + venc30 + ' parcela' + (venc30 > 1 ? 's' : '') + '</div></div>' +
            '<div class="credito-stats-card info"><div class="number">' + venc180 + '</div><div class="label">📆 Vence em 180 dias</div><div style="font-size:9px;color:var(--text-light);margin-top:2px;">' + venc180 + ' parcela' + (venc180 > 1 ? 's' : '') + '</div></div>' +
            '<div class="credito-stats-card info"><div class="number">' + venc365 + '</div><div class="label">📆 Vence em 365 dias</div><div style="font-size:9px;color:var(--text-light);margin-top:2px;">' + venc365 + ' parcela' + (venc365 > 1 ? 's' : '') + '</div></div>' +
            '</div>';
    ...
    _identificarInstituicao: function(texto) {
        ...
        // 1º TENTATIVA: Campo "Cooperativa:"
        ...
        // 2º TENTATIVA: Campo "Coop. Singular:"
        ...
        // 3º TENTATIVA: Nome da instituição
    ...
    _extrairComPadroes: function(texto, padroes) {
        ...
        for (var campo in padroes) {
            ...
            // Buscar texto semelhante ao padrão
    ...
    _extrairTodosOsDados: function(texto) {
        ...
        // Identificar instituição para o Modelo 4
        ...
        // ================================================================
            ...
            // ============================================================
            // CONTRATO (Modelo 2) - MANTIDO + NOVAS BUSCAS
            // ============================================================
            ...
            // ============================================================
            // MUTUÁRIO (Modelo 2) - MANTIDO + NOVAS BUSCAS
            // ============================================================
            ...
            // ============================================================
            // MODALIDADE (Modelo 2) - MANTIDO + NOVAS BUSCAS
            // ============================================================
            ...
            // ============================================================
            // SALDO QUITAÇÃO (Modelo 2) - MANTIDO + NOVAS BUSCAS
            // ============================================================
            ...
            // ============================================================
            // VALOR OPERAÇÃO (Modelo 2) - MANTIDO
            // ============================================================
            ...
            // INSTITUIÇÃO (Modelo 2) - MANTIDO + NOVA BUSCA
            ...
            // ============================================================
            // PARCELAS LIQUIDADAS (MODELO 2 - AMORTIZAÇÃO) - MANTIDO
            // ============================================================
        ...
        // ================================================================
        // MODELO 4: "Inteligente" (USA PADRÃO TREINADO)
        // ================================================================
        else if (padraoSalvo) {
            console.log('📄 MODELO 4: "Inteligente" detectado (padrão treinado para ' + instituicao + ')!');
            
            // Extrair dados com o padrão aprendido
            ...
            dados.saldoQuitacao = dadosModelo4.saldoQuitacao || dados.saldoQuitacao;
            dados.dataOperacao = dadosModelo4.dataLiberacao || dados.dataOperacao;
            
            // Tentar extrair parcelas em aberto (se não vieram do Modelo 4)
        ...
        // ================================================================
        // MODELO 3: "Somente Parcelas em Aberto" (INTACTO)
        // ================================================================
        else {
