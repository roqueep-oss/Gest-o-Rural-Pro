...
GR.Modules.Perfis = {
    ...
    // ================================================================
    // 🆕 CARREGAR PERFIL ATUAL (FALLBACK)
    // ================================================================
    carregarPerfilAtual: function() {
        ...
        // Fallback: usa o perfil master para o usuário específico
        var user = firebase.auth().currentUser;
        if (user && user.email === 'roqueep@gmail.com') {
            this.perfilAtual = this.perfis ? this.perfis.master : this.perfisPadrao.master;
        } else {
            this.perfilAtual = this.perfis ? this.perfis.visitante : this.perfisPadrao.visitante;
        }
    ...
    // ================================================================
    // FILTRAR MENU - CORRIGIDO PARA MOSTRAR TODOS OS MENUS PARA MASTER
    // ================================================================
    filtrarMenu: function() {
        console.log('🔍 Filtrando menu por permissões...');
        
        // Garante que o perfil atual está carregado
        if (!this.perfilAtual) {
            this.carregarPerfilAtual();
        }
        ...
        botoes.forEach(function(btn) {
            ...
            // SE FOR MASTER, MOSTRA TODOS OS BOTÕES
            if (isMaster) {
                            ...
                            <table style="width:100%;font-size:13px;">
                                ...
                                <tbody>
                                    ${propriedades.map(function(prop) {
                                        ...
                                        // Para master, sempre marcado e desabilitado
...
console.log('   - 🔧 CORREÇÃO: Menu filtrado corretamente para Master');