...
GR.Modules.Viveiro = {
    // ================================================================
    // 🆕 PROPRIEDADE ATIVA DO MÓDULO VIVEIRO
    // ================================================================
    ...
    getPropriedadeAtiva: function() {
        if (this._propriedadeAtiva === null) {
            ...
            if (!this._propriedadeAtiva || this._propriedadeAtiva === '') {
    ...
    // ================================================================
    // 🆕 GERAR SELECT DE PROPRIEDADES DO VIVEIRO
    // ================================================================
    _gerarSelectPropriedades: function() {
        ...
        var html = `
            <div style="display:flex;align-items:center;gap:6px;">
                <span style="font-size:10px;color:var(--text-light);font-weight:600;">📍</span>
                <select id="viveiro-propriedade-select" 
                        style="font-size:11px;padding:4px 8px;border-radius:4px;border:1px solid var(--border);background:var(--bg);color:var(--text);cursor:pointer;max-width:180px;"
                        onchange="GR.Modules.Viveiro._onPropriedadeChange(this.value)">
                    <option value="todas" ${propAtual === 'todas' ? 'selected' : ''}>🌍 Todas</option>
                    ${propriedades.map(function(p) {
    ...
    // ================================================================
    // RENDER PRINCIPAL - INTERFACE MODERNA COM PROPRIEDADE FIXA
    // ================================================================
    render: function() {
        var div = document.getElementById('viveiro-content');
        if (!div) return;

        // 🔥 OBTÉM A PROPRIEDADE ATIVA DO VIVEIRO
        ...
        // 🔥 FILTRA OS DADOS PELA PROPRIEDADE ATIVA DO VIVEIRO
        ...
        // 🔥 CONSTRÓI O HTML - INTERFACE MODERNA COM SELETOR DE PROPRIEDADE
        var html = `
            <!-- ============================================================ -->
            <!-- TOPO: BANNER DO PERFIL E FILTRO DE PROPRIEDADE -->
            <!-- ============================================================ -->
        ...
        console.log('📍 Propriedade ativa do Viveiro:', propViveiro);
    },
    ...
    // ================================================================
    // ATUALIZAR DADOS (MANTENDO A PROPRIEDADE SELECIONADA)
    // ================================================================
    _atualizarDados: function() {
        ...
        GR.State.carregarDados().then(function() {
            ...
            // Recarrega a propriedade ativa do localStorage
            try {
                var saved = localStorage.getItem('viveiro_propriedade_ativa');
                if (saved) {
    ...
    // ================================================================
    // ALTERNAR PROPRIEDADE - REMOVIDO (USAR SELETOR DO MÓDULO)
    // ================================================================
    // A função _alternarPropriedade foi removida pois agora usamos o seletor
    // de propriedade do módulo. Mantida apenas para compatibilidade.
    _alternarPropriedade: function() {
        // Esta função foi substituída pelo seletor de propriedade do módulo
    ...
    salvarVenda: function() {
        ...
        var propriedade = this.getPropriedadeAtiva(); // 🔥 USA A PROPRIEDADE DO MÓDULO
...
console.log('   - 🆕 Propriedade fixa do módulo (seletor no topo)');
...
console.log('   - 🆕 Propriedade persistida no localStorage');
console.log('   - 🆕 Todos os cadastros usam a propriedade do módulo');