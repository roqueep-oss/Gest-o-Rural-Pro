// ================================================================
// MÓDULO: VIVEIRO - SISTEMA COMPLETO COM PERMISSÕES (CORRIGIDO)
// ================================================================
// Versão: 2.6 - CORRIGIDO: Usa o sistema de perfis para permissões
...
GR.Modules.Viveiro = {
    ...
    // ================================================================
    // 🆕 VERIFICAR PERMISSÃO - USANDO O SISTEMA DE PERFIS (CORRIGIDO)
    // ================================================================
    ...
    // ================================================================
    // RENDER INTERNO - LÓGICA PRINCIPAL (CORRIGIDO)
    // ================================================================
...
console.log('✅ Módulo Viveiro v2.6 carregado com CORREÇÕES DE PERMISSÕES!');
console.log('📌 CORREÇÕES APLICADAS:');
console.log('   - 🔧 _isMasterOrAdmin() - Verifica se é Master/Admin pelo sistema de perfis');
console.log('   - 🔧 _temPermissao() - Usa o sistema de perfis para verificar permissões');
console.log('   - 🔧 _getPerfilUsuario() - Usa o sistema de perfis para obter o perfil');
console.log('   - 🔧 FORÇA permissões para Master/Admin (editar, criar, excluir)');
console.log('   - 🔧 Permissões básicas (visualizar, producao) sempre permitidas');
console.log('   - 🔧 Fallback seguro para todas as funções de permissão');
console.log('   - 🔧 Logs de debug para diagnóstico de permissões');
