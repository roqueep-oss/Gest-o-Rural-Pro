...
GR.Modules.Viveiro = {
    ...
    render: function() {
        ...
        var pedidos = GR.State.filtrarPorPropriedade(GR.State.data.viveiroPedidos || [], 'propriedade');
        var variedades = GR.State.filtrarPorPropriedade(GR.State.data.viveiroVariedades || [], 'propriedade');
        ...
        if (propAtiva !== 'todas') {
            ...
            pedidos = pedidos.filter(function(item) { return item.propriedade === propAtiva; });
            variedades = variedades.filter(function(item) { return item.propriedade === propAtiva; });
        }
        ...
        // Botão de pedidos (sempre visível se tiver permissão)
        if (permissoesGranulares.criarVenda) {
        ...
        // ================================================================
        // DASHBOARD DE MUDAS POR VARIEDADE E IDADE
        // ================================================================
        var variedadesMudas = {};
                ...
                <div class="card" style="padding:12px;margin-bottom:16px;border-left:4px solid #4CAF50;">
                    ...
                    <div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(200px,1fr));gap:8px;">
                        ${Object.keys(variedadesMudas).map(function(variedade) {
                            ...
                            // Verifica se tem mudas em produção para mostrar botão "Marcar Prontas"
                            var botaoProntas = '';
        ...
        var html = `
            ...
            <!-- ============================================================ -->
            <!-- DASHBOARD DE VARIEDADES E PEDIDOS -->
            <!-- ============================================================ -->
            ${dashboardMudasHtml}
            ${dashboardPedidosHtml}
                ...
                <div class="card" style="padding:0;overflow:hidden;border-top:4px solid #4CAF50;">
                    ...
                    <div style="padding:12px 16px;">
                        ...
                        <div style="display:flex;gap:4px;flex-wrap:wrap;margin-bottom:10px;">
                            ${botoesProducao}
                            ${permissoesGranulares.criarMuda ? `<button class="btn btn-sm btn-info" onclick="GR.Modules.Viveiro.abrirModalVariedade()" style="font-size:10px;padding:4px 10px;">🌱 Variedade</button>` : ''}
                        </div>
    ...
    _popularSelectVariedades: function(selectId) {
        ...
        if (propAtiva !== 'todas') {
            variedades = variedades.filter(function(v) { return v.propriedade === propAtiva; });
        }
    ...
    _popularSelectTrabalhadores: function() {
        ...
        if (propAtiva !== 'todas') {
            trabalhadores = trabalhadores.filter(function(t) { return t.propriedade === propAtiva; });
        }
    ...
    _popularSelectPedidos: function() {
        ...
        if (propAtiva !== 'todas') {
            pedidos = pedidos.filter(function(p) { return p.propriedade === propAtiva; });
        }
        
        // Filtra apenas pedidos pendentes ou confirmados (não entregues)
    ...
    _carregarPedidoVenda: function() {
        ...
        // Armazena o ID do pedido para usar no salvamento
    ...
    _marcarTodasProntas: function(variedade) {
        ...
        // Busca todas as mudas da variedade em produção
        var mudas = GR.State.filtrarPorPropriedade(GR.State.data.viveiroMudas || [], 'propriedade');
        if (propAtiva !== 'todas') {
            mudas = mudas.filter(function(m) { return m.propriedade === propAtiva; });
        }
    ...
    // ================================================================
    // RENDER PRODUÇÃO (COM PERMISSÕES) - MANTIDO ORIGINAL
    // ================================================================
    ...
    // ================================================================
    // RENDER VENDAS (COM PERMISSÕES) - MANTIDO ORIGINAL
    // ================================================================
    ...
    // ================================================================
    // RENDER LIVRO CAIXA (COM PERMISSÕES) - MANTIDO ORIGINAL
    // ================================================================
    ...
    // ================================================================
    // RENDER RELATÓRIOS (COM PERMISSÃO DE EXPORTAÇÃO) - MANTIDO ORIGINAL
    // ================================================================
    ...
    // ================================================================
    // FUNÇÕES DE SUB-ABAS - MANTIDO ORIGINAL
    // ================================================================
    ...
    // ================================================================
    // ALTERNAR PROPRIEDADE - MANTIDO ORIGINAL
    // ================================================================
    ...
    // ================================================================
    // MODAL: NOVA VENDA - MANTIDO ORIGINAL COM MELHORIAS
    // ================================================================
    abrirModalVenda: function(editId) {
        ...
        var propriedadeEl = document.getElementById('viveiro-venda-propriedade');
        if (propriedadeEl) propriedadeEl.value = GR.State.ui.propriedadeAtiva || '';
        ...
        if (editId) {
            ...
            if (item) {
                ...
                if (propriedadeEl) propriedadeEl.value = item.propriedade || '';
            }
        }
    ...
    salvarVenda: function() {
        ...
        var propriedade = propriedadeEl ? propriedadeEl.value : '';
        ...
        // Verifica se é uma venda baseada em pedido
        ...
        if (editId) {
            ...
            ref.add(dados).then(function() {
                ...
                // Baixa o estoque das mudas (atualiza status para Vendida)
                if (variedade) {
                    var mudas = GR.State.filtrarPorPropriedade(GR.State.data.viveiroMudas || [], 'propriedade');
                    var propAtiva = GR.State.ui.propriedadeAtiva || 'todas';
                    if (propAtiva !== 'todas') {
    ...
    // ================================================================
    // MODAL: NOVO LANÇAMENTO (CAIXA) - MANTIDO ORIGINAL
    // ================================================================
    abrirModalLancamento: function(editId) {
        ...
        var propriedadeEl = document.getElementById('viveiro-lancamento-propriedade');
        if (propriedadeEl) propriedadeEl.value = GR.State.ui.propriedadeAtiva || '';
    ...
    abrirModalVariedade: function(editId) {
        ...
        var propriedadeEl = document.getElementById('viveiro-variedade-propriedade');
        if (propriedadeEl) propriedadeEl.value = GR.State.ui.propriedadeAtiva || '';
    ...
    abrirModalPedido: function(editId) {
        ...
        var propriedadeEl = document.getElementById('viveiro-pedido-propriedade');
        if (propriedadeEl) propriedadeEl.value = GR.State.ui.propriedadeAtiva || '';
    ...
    salvarPedido: function() {
        ...
        if (editId) {
            ...
            ref.add(dados).then(function() {
                ...
                // Registra adiantamento como receita se houver
                if (adiantamento > 0) {
                    var caixaRef = db.collection('users').doc(uid).collection('viveiroCaixa');
                    caixaRef.add({
    ...
    abrirConverterPedido: function(pedidoId) {
        ...
        // Busca o estoque disponível para a variedade
        var mudas = GR.State.filtrarPorPropriedade(GR.State.data.viveiroMudas || [], 'propriedade');
        var propAtiva = GR.State.ui.propriedadeAtiva || 'todas';
        if (propAtiva !== 'todas') {
            mudas = mudas.filter(function(m) { return m.propriedade === propAtiva; });
    ...
    confirmarConverterPedido: function() {
        ...
        var vendaData = {
            ...
            valorTotal: valorTotal,
            pedidoId: pedidoId,
            propriedade: pedido.propriedade,
            dataCriacao: GR.Utils.now()
        };
        ...
        vendaRef.add(vendaData).then(function() {
            // 2. Baixa o estoque das mudas (atualiza status)
            var mudasProntas = mudas.filter(function(m) { 
            ...
            // 4. Registra no caixa como receita
            var caixaRef = db.collection('users').doc(uid).collection('viveiroCaixa');
    ...
    // ================================================================
    // FUNÇÕES EXISTENTES (COM VERIFICAÇÃO DE ELEMENTOS) - MANTIDAS
    // ================================================================
    abrirModalMuda: function(editId) {
        ...
        var propriedadeEl = document.getElementById('viveiro-muda-propriedade');
        if (propriedadeEl) propriedadeEl.value = GR.State.ui.propriedadeAtiva || '';
    ...
    abrirModalInsumo: function(editId) {
        ...
        var propriedadeEl = document.getElementById('viveiro-insumo-propriedade');
        if (propriedadeEl) propriedadeEl.value = GR.State.ui.propriedadeAtiva || '';
    ...
    salvarInsumo: function() {
        ...
        if (editId) {
            ...
            ref.add(dados).then(function() {
                ...
                // Registra no caixa como despesa (integração automática)
                var caixaRef = db.collection('users').doc(uid).collection('viveiroCaixa');
                caixaRef.add({
    ...
    abrirModalServico: function(editId) {
        ...
        // Popula select de trabalhadores e variedades
        ...
        var propriedadeEl = document.getElementById('viveiro-servico-propriedade');
        if (propriedadeEl) propriedadeEl.value = GR.State.ui.propriedadeAtiva || '';
    ...
    abrirModalTrabalhador: function(editId) {
        ...
        var propriedadeEl = document.getElementById('viveiro-trabalhador-propriedade');
        if (propriedadeEl) propriedadeEl.value = GR.State.ui.propriedadeAtiva || '';
    ...
    _onFornecedorSelecionado: function() {
        ...
        // Implementação similar à de outros módulos
    }
};
...
console.log('   - 🆕 Todas as funções CRUD implementadas');
console.log('   - 🆕 Verificação de elementos DOM para evitar erros');
console.log('   - 🆕 Dashboard de mudas por variedade e idade');
console.log('   - 🆕 Sistema de pedidos (reservas)');
console.log('   - 🆕 Serviços com trabalhador e período');
console.log('   - 🆕 Converter pedido em venda');
console.log('   - 🆕 Marcar mudas como prontas');
console.log('   - 🆕 Baixa automática de estoque ao vender');