...
GR.Modules.Viveiro = {
    ...
    // ================================================================
    // FUNÇÕES EXISTENTES (COM VERIFICAÇÃO DE ELEMENTOS)
    // ================================================================
    ...
    abrirModalServico: function(editId) {
        ...
        var responsavelEl = document.getElementById('viveiro-servico-responsavel');
        ...
        if (editId) {
            ...
            if (item) {
                if (descEl) descEl.value = item.descricao || '';
                if (dataEl) dataEl.value = item.data || '';
                if (responsavelEl) responsavelEl.value = item.responsavel || '';
